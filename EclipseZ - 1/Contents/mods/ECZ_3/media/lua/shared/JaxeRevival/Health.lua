...
JaxeRevival.Health.revive = function(player, bandage, restore, serverInitiated)
  ...
  if not serverInitiated and isClient() then JaxeRevival.Side.reportRevive(player) end
end

JaxeRevival.Health.kill = function(player, serverInitiated)
  ...
  if not serverInitiated and isClient() then JaxeRevival.Side.reportGiveUp() end
end
