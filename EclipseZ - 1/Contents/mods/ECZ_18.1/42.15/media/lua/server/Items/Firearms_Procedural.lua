...
SpawnMP5SD = (SandboxVars.Firearms.SpawnMP5SD)
SpawnMP510 = (SandboxVars.Firearms.SpawnMP510)
...
for i = 1, #FirearmsDistributionMagazines, 2 do
    if SpawnPython then
        ...
        table.insert(ProceduralDistributions.list[FirearmsDistributionMagazines[i]].items,
            FirearmsDistributionMagazines[i + 1] / 2)
        table.insert(ProceduralDistributions.list[FirearmsDistributionMagazines[i]].items, "Base.Bullets357Box")
        table.insert(ProceduralDistributions.list[FirearmsDistributionMagazines[i]].items,
            FirearmsDistributionMagazines[i + 1] / 2)
    end
    if SpawnColtAce or SpawnColtScout then
        table.insert(ProceduralDistributions.list[FirearmsDistributionMagazines[i]].items, "Base.22Clip")
        table.insert(ProceduralDistributions.list[FirearmsDistributionMagazines[i]].items,
            FirearmsDistributionMagazines[i + 1])
        table.insert(ProceduralDistributions.list[FirearmsDistributionMagazines[i]].items, "Base.22Clip")
        table.insert(ProceduralDistributions.list[FirearmsDistributionMagazines[i]].items,
            FirearmsDistributionMagazines[i + 1] / 2)
    ...
    if SpawnM1Garand then
        ...
        table.insert(ProceduralDistributions.list[FirearmsDistributionMagazines[i]].items, "Base.M1GarandClip")
        table.insert(ProceduralDistributions.list[FirearmsDistributionMagazines[i]].items,
            FirearmsDistributionMagazines[i + 1] / 4)
    ...
    if SpawnMP510 or SpawnColtDelta then
...
for i = 1, #FirearmsDistributionAmmoBoxes, 2 do
    ...
    table.insert(ProceduralDistributions.list[FirearmsDistributionAmmoBoxes[i]].items, FirearmsDistributionAmmoBoxes
        [i + 1])
    table.insert(ProceduralDistributions.list[FirearmsDistributionAmmoBoxes[i]].items, "Base.Bullets44Box")
    table.insert(ProceduralDistributions.list[FirearmsDistributionAmmoBoxes[i]].items,
        FirearmsDistributionAmmoBoxes[i + 1] / 2)
    if SpawnPython then
        table.insert(ProceduralDistributions.list[FirearmsDistributionAmmoBoxes[i]].items, "Base.Bullets357Box")
        table.insert(ProceduralDistributions.list[FirearmsDistributionAmmoBoxes[i]].items,
            FirearmsDistributionAmmoBoxes[i + 1])
        table.insert(ProceduralDistributions.list[FirearmsDistributionAmmoBoxes[i]].items, "Base.Bullets357Box")
        table.insert(ProceduralDistributions.list[FirearmsDistributionAmmoBoxes[i]].items,
            FirearmsDistributionAmmoBoxes[i + 1] / 2)
    end
    if SpawnColtAce or SpawnColtScout then
        ...
        table.insert(ProceduralDistributions.list[FirearmsDistributionAmmoBoxes[i]].items,
            FirearmsDistributionAmmoBoxes[i + 1] * 5)
        table.insert(ProceduralDistributions.list[FirearmsDistributionAmmoBoxes[i]].items, "Base.Bullets22Box")
        table.insert(ProceduralDistributions.list[FirearmsDistributionAmmoBoxes[i]].items,
            FirearmsDistributionAmmoBoxes[i + 1])
    end
...
for i = 1, #FirearmsDistributionAmmoCartons, 2 do
    ...
    table.insert(ProceduralDistributions.list[FirearmsDistributionAmmoCartons[i]].items,
        FirearmsDistributionAmmoCartons[i + 1])
    table.insert(ProceduralDistributions.list[FirearmsDistributionAmmoCartons[i]].items, "Base.Bullets4440Carton")
    table.insert(ProceduralDistributions.list[FirearmsDistributionAmmoCartons[i]].items,
        FirearmsDistributionAmmoCartons[i + 1] / 2)
    if SpawnPython then
    ...
    if SpawnColtAce or SpawnColtScout then
        ...
        table.insert(ProceduralDistributions.list[FirearmsDistributionAmmoCartons[i]].items,
            FirearmsDistributionAmmoCartons[i + 1] * 5)
        table.insert(ProceduralDistributions.list[FirearmsDistributionAmmoCartons[i]].items, "Base.Bullets22Carton")
        table.insert(ProceduralDistributions.list[FirearmsDistributionAmmoCartons[i]].items,
            FirearmsDistributionAmmoCartons[i + 1])
    end
...
for i = 1, #FirearmsDistributionPistols, 2 do
    if SpawnGlock17 then
        ...
        table.insert(ProceduralDistributions.list[FirearmsDistributionPistols[i]].items,
            FirearmsDistributionPistols[i + 1] * 1.75)
        table.insert(ProceduralDistributions.list[FirearmsDistributionPistols[i]].items, "Base.Glock17Mag")
        table.insert(ProceduralDistributions.list[FirearmsDistributionPistols[i]].items, FirearmsDistributionPistols
            [i + 1])
        table.insert(ProceduralDistributions.list[FirearmsDistributionPistols[i]].items, "Base.Glock17Mag")
        table.insert(ProceduralDistributions.list[FirearmsDistributionPistols[i]].items,
            FirearmsDistributionPistols[i + 1] / 2)
    end
    if SpawnPython then
    ...
    if SpawnColtAce then
        ...
        table.insert(ProceduralDistributions.list[FirearmsDistributionPistols[i]].items, "Base.22Clip")
        table.insert(ProceduralDistributions.list[FirearmsDistributionPistols[i]].items,
            FirearmsDistributionPistols[i + 1] / 3)
    end
end
...
for i = 1, #FirearmsDistributionRifles, 2 do
    if SpawnFNFal then
        ...
        table.insert(ProceduralDistributions.list[FirearmsDistributionRifles[i]].items,
            FirearmsDistributionRifles[i + 1] /
            2)
        table.insert(ProceduralDistributions.list[FirearmsDistributionRifles[i]].items, "Base.FN_FAL_Mag")
        table.insert(ProceduralDistributions.list[FirearmsDistributionRifles[i]].items, FirearmsDistributionRifles
            [i + 1])
        table.insert(ProceduralDistributions.list[FirearmsDistributionRifles[i]].items, "Base.FN_FAL_Mag")
        table.insert(ProceduralDistributions.list[FirearmsDistributionRifles[i]].items,
            FirearmsDistributionRifles[i + 1] /
    ...
    if SpawnMP5SD then
        ...
        table.insert(ProceduralDistributions.list[FirearmsDistributionRifles[i]].items,
            FirearmsDistributionRifles[i + 1] / 50)
    end
    if SpawnMP5 or SpawnMP5SD then
...
for i = 1, #FirearmsDistributionSchoolLocker, 2 do
    ...
    table.insert(ProceduralDistributions.list[FirearmsDistributionSchoolLocker[i]].items,
        FirearmsDistributionSchoolLocker[i + 1] * 2)
    if SpawnGlock17 then
    ...
    if SpawnUZI then
        ...
        table.insert(ProceduralDistributions.list[FirearmsDistributionSchoolLocker[i]].items,
            FirearmsDistributionSchoolLocker[i + 1] / 5)
...
for i = 1, #FirearmsDistributionPolice, 2 do
    if SpawnMP5 then
        ...
        table.insert(ProceduralDistributions.list[FirearmsDistributionPolice[i]].items, FirearmsDistributionPolice
            [i + 1]);
        table.insert(ProceduralDistributions.list[FirearmsDistributionPolice[i]].items, "MP5SD");
        table.insert(ProceduralDistributions.list[FirearmsDistributionPolice[i]].items,
            FirearmsDistributionPolice[i + 1] / 50);
        table.insert(ProceduralDistributions.list[FirearmsDistributionPolice[i]].items, "MP5Mag");
        table.insert(ProceduralDistributions.list[FirearmsDistributionPolice[i]].items, FirearmsDistributionPolice
            [i + 1]);
        table.insert(ProceduralDistributions.list[FirearmsDistributionPolice[i]].items, "MP5Mag");
        table.insert(ProceduralDistributions.list[FirearmsDistributionPolice[i]].items,
            FirearmsDistributionPolice[i + 1] /
            2);
...
for i = 1, #FirearmsDistributionPoliceAmmo, 2 do
    if SpawnPython then
        ...
        table.insert(ProceduralDistributions.list[FirearmsDistributionPoliceAmmo[i]].items,
            FirearmsDistributionPoliceAmmo[i + 1]);
        table.insert(ProceduralDistributions.list[FirearmsDistributionPoliceAmmo[i]].items, "Bullets357Box");
        table.insert(ProceduralDistributions.list[FirearmsDistributionPoliceAmmo[i]].items,
            FirearmsDistributionPoliceAmmo[i + 1] / 2);
        table.insert(ProceduralDistributions.list[FirearmsDistributionPoliceAmmo[i]].items, "Bullets357Box");
        table.insert(ProceduralDistributions.list[FirearmsDistributionPoliceAmmo[i]].items,
            FirearmsDistributionPoliceAmmo[i + 1] / 4);
    end
    if SpawnMP510 or SpawnColtDelta then
...
for i = 1, #FirearmsDistributionShotguns, 2 do
    ...
    if SpawnSPAS12 then
        ...
        table.insert(ProceduralDistributions.list[FirearmsDistributionShotguns[i]].items,
            FirearmsDistributionShotguns[i + 1] / 4);
    end
end
...
if SpawnSuppressors then
    if SpawnHandgunSuppressors then
        for i = 1, #FirearmsDistributionSilencers, 2 do
            ...
            table.insert(ProceduralDistributions.list[FirearmsDistributionSilencers[i]].items,
                FirearmsDistributionSilencers[i + 1] * SuppressorLootRarity);
    ...
    if SpawnRifleSuppressors then
        for i = 1, #FirearmsDistributionSilencers, 2 do
            ...
            table.insert(ProceduralDistributions.list[FirearmsDistributionSilencers[i]].items,
                (FirearmsDistributionSilencers[i + 1] * SuppressorLootRarity / 2));
            ...
            table.insert(ProceduralDistributions.list[FirearmsDistributionSilencers[i]].items,
                (FirearmsDistributionSilencers[i + 1] * SuppressorLootRarity / 4));
        end
    end
...
for i = 1, #FirearmsDistributionAttachments, 2 do
    ...
    table.insert(ProceduralDistributions.list[FirearmsDistributionAttachments[i]].items,
        FirearmsDistributionAttachments[i + 1] / 2);
    table.insert(ProceduralDistributions.list[FirearmsDistributionAttachments[i]].items, "Rifle_Flashlight");
    table.insert(ProceduralDistributions.list[FirearmsDistributionAttachments[i]].items,
        FirearmsDistributionAttachments[i + 1]);
...
for i = 1, #FirearmsDistributionStocks, 2 do
    ...
    if SpawnMossberg500Tactical then
        ...
        table.insert(ProceduralDistributions.list[FirearmsDistributionStocks[i]].items, FirearmsDistributionStocks
            [i + 1]);
        table.insert(ProceduralDistributions.list[FirearmsDistributionStocks[i]].items, "ShotgunStock");
        table.insert(ProceduralDistributions.list[FirearmsDistributionStocks[i]].items,
            FirearmsDistributionStocks[i + 1] /
            2);
