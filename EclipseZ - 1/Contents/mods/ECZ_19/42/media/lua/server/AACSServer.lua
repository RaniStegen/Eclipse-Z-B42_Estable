...
local function _iterList(listObj, fn)
    ...
    if size ~= nil then
        ...
        local okGet = pcall(function() return listObj:get(0) end)
        if okGet then
            for i = 0, size - 1 do
                local okItem, v = pcall(function() return listObj:get(i) end)
                if okItem and fn(v) == true then return true end
            end
            return false
        end
    end
    ...
    if okIter and it then
        while it:hasNext() do
            if fn(it:next()) == true then return true end
        end
    end
