-- B42.19 preloads ISInventoryPaneContextMenu; avoid obsolete require path.
...
function clothingInventoryContainerContextFix.apply(player, context, items)
    ...
    if clothing and ISInventoryPaneContextMenu and ISInventoryPaneContextMenu.doWearClothingMenu and
