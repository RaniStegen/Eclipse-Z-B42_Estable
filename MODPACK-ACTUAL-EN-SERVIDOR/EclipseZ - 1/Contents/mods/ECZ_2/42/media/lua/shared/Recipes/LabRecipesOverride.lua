...
-- MAKEGLASSSHIV
-- ============================
patchRecipe("MakeGlassShiv", [[{ inputs {
            item 1 tags[base:brokenglass;LabItems.MatShatteredGlass] flags[Prop2],
            item 1 tags[base:simpleweaponbinding;base:tape] flags[DontReplace],
} }]])
