...
function EHR.Keybinds.Initialize(forceRefresh)
    ...
    ensureTickBox(
        ...
        "Usar la tecla rápida para abrir EHR",
        true,
        "UI_EHR_PrimaryHealthPanel_tt",
        "El corazón siempre abre el panel de EHR. Esta opción decide si la tecla rápida también abre EHR o abre el panel médico del juego."
    )
    ensureTickBox(
...
function EHR.Keybinds.ShouldHeartButtonOpenEHR()
    -- Eclipse Z fuerza el panel completo de EHR desde el botón del corazón.
    return true
end
