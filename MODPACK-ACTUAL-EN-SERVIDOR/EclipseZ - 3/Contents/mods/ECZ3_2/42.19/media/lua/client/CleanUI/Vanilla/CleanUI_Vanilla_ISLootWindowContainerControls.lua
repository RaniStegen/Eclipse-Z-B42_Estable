...
function CleanUI_Vanilla_ISLootWindowContainerControls.AddHandler(handlerClass, displayToRight)
...
CleanUI_Vanilla_ISLootWindowContainerControls.AddHandler(ISLootWindowObjectControlHandler_MannequinWearAll, true)
CleanUI_Vanilla_ISLootWindowContainerControls.AddHandler(ISLootWindowObjectControlHandler_MannequinSwitchOutfit, true)
CleanUI_Vanilla_ISLootWindowContainerControls.AddHandler(ISLootWindowObjectControlHandler_PropaneBarbecueRemoveTank, true)
CleanUI_Vanilla_ISLootWindowContainerControls.AddHandler(ISLootWindowObjectControlHandler_PropaneBarbecueAddTank, true)
CleanUI_Vanilla_ISLootWindowContainerControls.AddHandler(ISLootWindowObjectControlHandler_PropaneBarbecueToggle, true)
CleanUI_Vanilla_ISLootWindowContainerControls.AddHandler(ISLootWindowObjectControlHandler_ClothingWasherToggle, true)
CleanUI_Vanilla_ISLootWindowContainerControls.AddHandler(ISLootWindowObjectControlHandler_ClothingDryerToggle, true)
CleanUI_Vanilla_ISLootWindowContainerControls.AddHandler(ISLootWindowObjectControlHandler_CombinationWasherDryerSetMode, true)
CleanUI_Vanilla_ISLootWindowContainerControls.AddHandler(ISLootWindowObjectControlHandler_CombinationWasherDryerToggle, true)
CleanUI_Vanilla_ISLootWindowContainerControls.AddHandler(ISLootWindowObjectControlHandler_StoveSettings, true)
CleanUI_Vanilla_ISLootWindowContainerControls.AddHandler(ISLootWindowObjectControlHandler_StoveToggle, true)
CleanUI_Vanilla_ISLootWindowContainerControls.AddHandler(ISLootWindowObjectControlHandler_VehicleLockTrunk, true)
CleanUI_Vanilla_ISLootWindowContainerControls.AddHandler(ISLootWindowObjectControlHandler_VehicleCloseTrunk, true)
CleanUI_Vanilla_ISLootWindowContainerControls.AddHandler(ISLootWindowObjectControlHandler_PutOut, true)
CleanUI_Vanilla_ISLootWindowContainerControls.AddHandler(ISLootWindowObjectControlHandler_LightFireOption, true)
CleanUI_Vanilla_ISLootWindowContainerControls.AddHandler(ISLootWindowObjectControlHandler_AddFuelOption, true)
CleanUI_Vanilla_ISLootWindowContainerControls.AddHandler(ISLootWindowObjectControlHandler_RemoveCampfire, true)
CleanUI_Vanilla_ISLootWindowContainerControls.AddHandler(ISLootWindowObjectControlHandler_AddCorpseToCampfire, true)
