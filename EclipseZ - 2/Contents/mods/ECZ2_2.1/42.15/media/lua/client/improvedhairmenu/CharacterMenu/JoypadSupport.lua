...
-- NOTE: Overwrite to insert our menu in the joypad order (use CharacterCreationMain like vanilla)
function CharacterCreationMainCharacterPanel:loadJoypadButtons(joypadData)
    ...
    self.joypadButtonsY = {}
    local charCreationMain = self.parent  -- vanilla uses self.parent (CharacterCreationMain)
    -- Name & gender inputs
    ...
    -- Hair (modal button or inline panel)
