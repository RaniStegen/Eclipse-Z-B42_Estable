...
function CharacterCreationMain:onHairPickerToggle(index, selected)
    local enabled = selected and _IHM_hasImprovedHairPicker()
...
function CharacterCreationMain:createHairTypeBtn()
    ...
    local pickerToggleLabel = _IHM_getTextOrFallback("UI_IHM_UseImprovedHairPicker", "Improved Hair Picker")
    local pickerToggleTooltip = _IHM_getTextOrFallback("UI_IHM_UseImprovedHairPicker_Tooltip", "Enabled = improved picker, disabled = vanilla picker.")
    ...
    local pickerEnabled = _IHM_hasImprovedHairPicker() and _getLive("cc_use_improved_hair_picker", false)
